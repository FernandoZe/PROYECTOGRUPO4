...
class Carrito extends PublicController{
    private $redirectTo = "index.php?page=Mnt-Carritos";
    ...
    private function validatePostData(){
        ...
        if(isset($_POST["catdesc"])){
            if (!in_array( $_POST["catdesc"], array("ACT","INA"))){
                throw new Exception("catdesc incorrect value");
            }
        }else {
            if($this->viewData["mode"]!=="DEL") {
                throw new Exception("catdesc not present in form");
            }
        }
        if(isset($_POST["mode"])){
        ...
        if($this->viewData["mode"]!=="DEL"){
            $this->viewData["catdesc"] = $_POST["catdesc"];
        }
    }
    ...
    private function render(){
        ...
        if($this->viewData["mode"] === "INS") {
            ...
            //$this->viewData["catdesc"] = $tmpCategorias["catdesc"];
            \Utilities\ArrUtils::mergeFullArrayTo($tmpCategorias, $this->viewData);
            $this->viewData["catdesc_ACT"] = $this->viewData["catdesc"] === "ACT" ? "selected": "";
            $this->viewData["catdesc_INA"] = $this->viewData["catdesc"] === "INA" ? "selected": "";
