...
<section class="row">
  ...
  >
    ...
    <section class="row">
      <label for="catdesc" class="col-4">Estado</label>
      <select id="catdesc" name="catdesc" {{if readonly}}disabled{{endif readonly}}>
        <option value="ACT" {{catdesc_ACT}}>Activo</option>
        <option value="INA" {{catdesc_INA}}>Inactivo</option>
      </select>
    </section>
    {{if has_errors}}
        <section>
