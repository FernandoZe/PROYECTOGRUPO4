...
<section class="row">
  ...
  >
    ...
    <input type="text" name="rolescoddummy" value="{{rolescod}}"/>
    </section>
    <section class="row">
      <label for="rolesdsc" class="col-4">Descripcion</label>
      <input type="text" {{readonly}} name="rolesdsc" value="{{rolesdsc}}" maxlength="45" placeholder="Descripcion"/>
      {{if rolesdsc_error}}
